...
Une fois le périmètre d'agroforêts suspectées cerné, il est nécessaire de croiser ces données avec les quelques données de terrain disponibles quelque soit
